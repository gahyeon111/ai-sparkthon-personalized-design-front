...
const AXIS1_SOURCE: Axis1SourceItem[] = [
  {
    ...
    label_ko: "가성비추구형",
    display_label_ko: "가성비 추구형",
    description: "할인, 절약, 쿠폰, 가격 비교를 중시하는 실속형 고객.",
    profile_image: "/personas/per-1.png",
  ...
  },
  {
    ...
    label_ko: "프리미엄추구형",
    display_label_ko: "프리미엄 추구형",
    description: "브랜드 품격, 고급 소재, 희소성과 큐레이션된 경험을 선호하는 고객.",
    profile_image: "/personas/per-2.png",
  ...
  },
  {
    ...
    label_ko: "경험감성추구형",
    display_label_ko: "경험감성 추구형",
    description: "감성, 힐링, 취향, 스토리텔링 경험을 중시하는 고객.",
    profile_image: "/personas/per-3.png",
  ...
  },
  {
    ...
    label: "Trend Chaser",
    label_ko: "트렌드민감형",
    display_label_ko: "트렌드 민감형",
    description: "SNS, 숏폼, 팝업, 굿즈, 한정성에 민감한 트렌드형 고객.",
    profile_image: "/personas/per-4.png",
  ...
  },
  {
    ...
    label: "Trust Seeker",
    label_ko: "안전신뢰추구형",
    display_label_ko: "안전신뢰 추구형",
    description: "검증된 정보, 보장, 리뷰, 안정성을 중시하는 신뢰형 고객.",
    profile_image: "/personas/per-5.png",
  ...
  },
  {
    ...
    label_ko: "관계선물중심형",
    display_label_ko: "관계선물 중심형",
    description: "선물, 감사, 관계, 나눔의 맥락에 반응하는 고객.",
    profile_image: "/personas/per-6.png",
...
export const AXIS1_TYPES = AXIS1_SOURCE.map((value, index) => ({
  ...
  code: `#${index + 1}`,
  name: value.label_ko,
  displayName: value.display_label_ko ?? value.label_ko,
  ...
  gender: value.persona_signals.gender ?? "여성",
